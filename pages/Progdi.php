        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Tabel Program Studi</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Tabel Program Studi</h5>
                            <div class="card-body">
        ...
        var myChart3 = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        <?php
                        $jumlah_d3 = mysqli_query($koneksi, "select * from dtl_progdi where jenjang='D3'");
                        echo mysqli_num_rows($jumlah_d3);
                        ?>,
                        <?php
                        $jumlah_s1 = mysqli_query($koneksi, "select * from dtl_progdi where jenjang='S1'");
                        echo mysqli_num_rows($jumlah_s1);
                        ?>,
                        <?php
                        $jumlah_s2 = mysqli_query($koneksi, "select * from dtl_progdi where jenjang='S2'");
                        echo mysqli_num_rows($jumlah_s2);
                        ?>,
                        <?php
                        $jumlah_s3 = mysqli_query($koneksi, "select * from dtl_progdi where jenjang='S3'");
