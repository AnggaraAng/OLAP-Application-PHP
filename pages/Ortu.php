...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Table Orang Tua</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Tabel Orang Tua</h5>
                            <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    Copyright © 2020 Kelompok Anggi Anggara</a>.
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
    ...
    <script>
        ...
        var myChart2 = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["Kota Salatiga", "Kab. Semarang", "Kota Semarang"],
                datasets: [{
                    label: '',
                    data: [
                        <?php
                        $jumlah_salatiga = mysqli_query($koneksi, "select * from dtl_mhs where kota_ortu='Kota Salatiga'");
                        echo mysqli_num_rows($jumlah_salatiga);
                        ?>,
                        <?php
                        $jumlah_kab_semarang = mysqli_query($koneksi, "select * from dtl_mhs where kota_ortu='Kab. Semarang'");
                        echo mysqli_num_rows($jumlah_kab_semarang);
                        ?>,
                        <?php
                        $jumlah_semarang = mysqli_query($koneksi, "select * from dtl_mhs where kota_ortu='Kota Semarang'");
                        echo mysqli_num_rows($jumlah_semarang);
                        ?>
                    ],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
